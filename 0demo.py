...
image_files = sorted(img_dir.glob("*"))  # Returns a list of Path objects
print(image_files)
...
for img_path in image_files:
    ...
    label_path = label_dir / f"{img_path.stem}.txt"  # Convert filename to .txt
    ...
    for label in label_lines:
        ...
        try:
            ...
            print(f"Error processing label data for {img_path.name}: {e}")
            continue
